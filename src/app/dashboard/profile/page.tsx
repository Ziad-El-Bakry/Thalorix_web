...
import {
  ...
  ChevronRight, Bookmark, Settings, MoreHorizontal,
...
export default function ProfilePage() {
  ...
  const posts = PROFILE_POSTS.map(p => ({
    ...p,
    author: { ...p.author, name: userName, avatar: previewImage }
  }));
  ...
  return (
    <div className="w-full max-w-7xl mx-auto relative">
      ...
      >
        {/* Cover Banner */}
        <div className="relative h-[180px] md:h-[220px] overflow-hidden group">
        ...
        <div className="relative px-5 md:px-8 pb-6">
          ...
          <div className="relative -mt-16 mb-3 inline-block group">
            ...
            <motion.div
              ...
              className="w-[120px] h-[120px] rounded-full overflow-hidden bg-gray-200 border-4 border-white shadow-xl flex items-center justify-center relative cursor-pointer z-10"
            >
